...
{
    public partial class Bai10 : UserControl
    {
        ...
        private void Bai10_Load(object sender, EventArgs e)
        {
            ...
            myUsercontrol[0] = new Phan1.Bai_10.BaiTap1();
            myUsercontrol[1] = new Phan1.Bai_10.BaiTap2();
            myUsercontrol[2] = new Phan1.Bai_10.BaiTap3();
            myUsercontrol[3] = new Phan1.Bai_10.BaiTap4();


            for (int i = 0; i < nUsct; i++)
            {
                pnbai10.Controls.Add(myUsercontrol[i]);
